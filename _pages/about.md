...
I am a senior undergraduate student pursuing a **Bachelor of Engineering in Systems and Biomedical Engineering** at **Cairo University** (2021-2026). I currently hold a **CGPA of 3.8/4.0** and am **ranked 6th** in my class.
...
* **Trans Quake:** Developed a Transformer-based architecture to classify extraterrestrial seismic events from NASA's Apollo mission data with 0.88 accuracy.
* **Cognitive Control Analysis:** Performed group-level fMRI analysis on Flanker Task data using FSL and GLM to identify activation in the prefrontal cortex. -->
